...
void second_window()
{
	...
	glPushMatrix();
    glTranslatef(200,635,0);
     building3_scal();
	glPopMatrix();
    glPushMatrix();
    glTranslatef(460, 635, 0);
    building3_scal();
    glPopMatrix();
    glPushMatrix();
    glTranslatef(720, 635, 0);
    building3_scal();
    glPopMatrix();



	//if bus infront of apartment 
	if(girl_out){
        glPushMatrix();
...
int main()
{
    ...
    glutCreateWindow("COE18 Project 'The Bus Simulator'");
    init();
